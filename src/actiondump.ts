...
export enum TypeToString {
    ...
    "NUMBER" = "§cNumber",
    "LOCATION" = "§aLocation",
    "VECTOR" = "§x§2§a§f§f§a§aVector",
    "SOUND" = "§9Sound",
    "PARTICLE" = "§x§a§a§5§5§f§fParticle Effect",
    "POTION" = "§x§f§f§5§5§7§fPotion Effect",
    "VARIABLE" = "§eVariable",
    "ANY_TYPE" = "§x§f§f§d§4§7§f§8Any Value",
    "ITEM" = "§6Item",
    "BLOCK" = "§6Block",
    "ENTITY_TYPE" = "§6Entity Type",
    "VEHICLE" = "§6Vehicle",
    "SPAWN_EGG" = "§6Spawn Egg",
    "PROJECTILE" = "§6Projectile",
    "BLOCK_TAG" = "§bBlock Tag",
    "LIST" = "§2List",
    "DICT" = "§x§f§f§d§4§7§f§8Dictionary",
    "NONE" = "§x§8§0§8§0§8§0None",
}
